        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('environmentreservationApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-environmentreservationApp-error');
                                var entityKey = httpResponse.headers('X-environmentreservationApp-params');
                                if (errorHeader) {
